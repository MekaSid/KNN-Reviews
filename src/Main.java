...
//            System.out.printf("Test Set Size: %d\n", testSet.size());
            ...
            for (int k = 1; k <= 9; k += 2) {
                ...
                for (DataPoint dp : validSet) {
                    ...
                    qv.normalize(docs);
                    List<Integer> topDocs = qv.findClosestDocuments(docs, new CosineDistance(), k);
            ...
            for (int i = 0; i < testSet.size(); i++) {
                ...
                ArrayList<Integer> topDocs = qv.findClosestDocuments(docs, new CosineDistance(), bestK);
                int pred = majorityLabel(topDocs, labels);
                int actual = dp.label;
            ...
            while (true) {
                ...
                q.normalize(docs);
                ArrayList<Integer> top = q.findClosestDocuments(docs, new CosineDistance(), bestK);
